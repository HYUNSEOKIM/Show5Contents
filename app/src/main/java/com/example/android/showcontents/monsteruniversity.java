...
public class monsteruniversity extends AppCompatActivity {
    ...
    private String createMessage(boolean title, boolean genre, boolean story, boolean release, boolean production){
        ...
        if (story){
            Message += "\nStory : Ever since he was a kid monster, Mike Wazowski (Billy Crystal) has dreamed of becoming a Scarer." +
                    "\n To make his dream a reality, he enrolls at Monsters University." +
                    "\nDuring his first semester, he meets Sulley (John Goodman), a natural-born Scarer." +
        ...
        if (release){
            Message += "\nInitial Relase : July 11, 2013 (Hong Kong)\n";
        }
        if (production){
